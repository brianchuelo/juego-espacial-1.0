...
# agregar musica
mixer.music.load('bad bunny.mp3')
...
# puntaje
puntaje = 0
fuente = pygame.font.Font('racespaceregular.otf',32)
texto_x = 10
texto_y = 10

# texto final de juego
fuente_final = pygame.font.Font('arcade_i.ttf',40)


def texto_final():
    mi_fuente_final = fuente_final.render("GAMER OVER", True, (255, 255, 255))
    pantalla.blit(mi_fuente_final, (200,300))
